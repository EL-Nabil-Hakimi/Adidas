...
<div class="row ">
  <div class="col-lg-7 mx-auto">
    <div class="card mt-2 mx-auto p-4 bg-light">
        ...
        <div class = "container">
       <form id="contact-form"  action="modifycategorie" method="POST">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input id="form_name" type="text" name="name" class="form-control" placeholder="Please enter your firstname *" value="{{$categorie->name}}" required="required" data-error="Firstname is required.">
                    </div>
                </div>
