...
<div class="row ">
  <div class="col-lg-7 mx-auto">
    <div class="card mt-2 mx-auto p-4 bg-light">
        ...
        <div class = "container">
    <form id="contact-form" role="form" action="Modify_Client" method="POST">
      @csrf       
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input id="form_name" type="text" name="nom" class="form-control" placeholder="Please enter your firstname *" value="{{$client->nom}}" required="required" data-error="Firstname is required.">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input id="form_lastname" type="text" name="prenom" class="form-control" placeholder="Please enter your lastname *" value="{{$client->prenom}}" required="required" data-error="Lastname is required.">
                                                        </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input id="form_email" type="email" name="email" class="form-control" placeholder="Please enter your email *" value="{{$client->email}}" required="required" data-error="Valid email is required.">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input id="form_email" type="text" name="adresse" class="form-control" placeholder="Please enter your email *" value="{{$client->adresse}}" required="required" data-error="Valid email is required.">
